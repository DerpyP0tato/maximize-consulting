          ...
          >
            ...
            <div className="pt-8 border-t border-white/10">
              ...
              <div className="text-lg text-zinc-400 space-y-4 leading-relaxed">
                ...
                <p>
                  My background sits at the intersection of business and engineering, where I’ve worked on automation, analytics, and internal tools that eliminate manual work and make data easier to understand and act on. I’ve supported teams across startups, large corporations, and nonprofits by connecting disconnected systems, setting up reliable analytics, and guiding technical decisions that actually fit their scale and resources.
                </p>
                <p>
